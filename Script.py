...
class script(object):
    START_TXT = environ.get("START_TXT", '''<b>Hello {} 👋,I'm 𝕄𝕠𝕧𝕚𝕖 𝕋𝕒𝕝𝕜𝕚𝕖𝕫 𝔹𝕠𝕥.I can send you Movies,Series and Animes Through My Channel🙂💕.</b>
...
<b>URL buttons:</b>
<code>[Button Text](buttonurl:https://t.me/movietalkiezbot)</code>
